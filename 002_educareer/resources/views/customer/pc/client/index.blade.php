...
@section('title', '求人掲載をご検討中の採用担当者様へ | 教育業界に特化した就職・転職の求人サービス【Education Career】')
@section('description', '教育業界の採用担当者の方へ。EducationCareerは教育関係の仕事に関心のあるすべての方に向けた求人広告サービスです。正社員や業務委託、パートやアルバイト、インターン、会社を辞めずに手伝えるプロボノやボランティアなど多様な働き方の求人を掲載することができます。')
...
@section('content')
  ...
  <div class="contact-btn">
    ...
    <p><a href="/contact" class="m-button m-button--primary">お問い合わせ</a></p>
  </div>
  </div>
</div>

<div class="content1">
  <h2>教育業界専門の転職サイトEducation Careerの特徴</h2>
  <div class="feature1">
    <section class="feature-box">
      <div><img src="/images/image1.jpg" alt=""></div>
      <div class="feature-bc"><figcaption>求人の掲載は全て無料、<br>期間の制限もありません</figcaption></div>
    ...
    <section class="feature-box">
      ...
      <div class="feature-bc"><figcaption>職種、業態、雇用形態こだわらず<br>利用が可能</figcaption></div>
    ...
    <section class="feature-box">
      ...
      <div class="feature-bc"><figcaption>シンプルな管理画面で、<br>求人作成・応募管理もカンタン</figcaption></div>
  ...
  <div class="feature2">
    <section class="feature-box">
      ...
      <div class="feature-bc"><figcaption>教育業界に関心の高い求職者に<br>出会える</figcaption></div>
      <p class="feature-txt">EdTech Media（教育×テクノロジーに特化したWebメディア）との連携、 業界に特化したプロモーションにより教育業界への関心の高い求職者と出会うことが可能です。<br>
          ※詳細はお問い合わせください。</p>
    </section>
    <section class="feature-box">
      <div><img src="/images/image5.jpg" alt=""></div>
      <div class="feature-bc"><figcaption>業界専門の転職エージェントが<br>最適な人材を紹介</figcaption></div>
...
<div class="content3">
  <h2>Education Careerの利用をご希望の企業・担当者様へ</h2>
  <div class="float">
  <div class="contact-btn">
