...
@section('title', '利用規約 | 教育業界に特化した就職・転職の求人サービス【Education Career】')
@section('description', 'EducationCareerの利用規約について。EducationCareerは教育業界に就職・転職したい方、関心のあるすべての方に向けた求人情報サービスです。正社員や業務委託、パートやアルバイト、インターン、会社を辞めずに手伝えるプロボノやボランティアなど多様な働き方が選べます。')
