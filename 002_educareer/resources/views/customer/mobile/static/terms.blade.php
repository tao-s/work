...
@section('content')
      ...
      <h1 class="m-heading m-heading--h2">利用規約</h1>
      <div class="l-group l-box s">
        <p>本利用規約（以下「本規約」と言います。）には、本サービスの提供条件及び当社と登録ユーザーの皆様との間の権利義務関係が定められています。<br>本サービスの利用に際しては、本規約の全文をお読みいただいたうえで、本規約に同意いただく必要があります。</p>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第1条（適用）</p>
          <ol class="m-list m-list--ordered">
            ...
            <li>当社が当社ウェブサイト上で掲載する本サービス利用に関するルール（http://.......）は、本規約の一部を構成するものとします。</li>
            <li>本規約の内容と、前項のルールその他の本規約外における本サービスの説明等とが異なる場合は、本規約の規定が優先して適用されるものとします。</li>
          </ol>
        </div>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第2条（定義）</p>
          ...
          <ol class="m-list m-list--ordered">
            ...
            <li>「登録データ」とは、登録ユーザーが本サービスを利用して投稿その他送信するコンテンツ（文章、画像、その他のデータを含みますがこれらに限りません。）を意味します。</li>
            <li>「当社」とは、株式会社ファンオブライフを意味します。</li>
            <li>「当社ウェブサイト」とは、そのドメインが「education-career.jp」である、当社が運営するウェブサイト（理由の如何を問わず、当社のウェブサイトのドメインまたは内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。</li>
            <li>「登録ユーザー」とは、第3条（登録）に基づいて本サービスの利用者としての登録がなされた個人または法人を意味します。</li>
            <li>「本サービス」とは、当社が提供する看護師転職ゲートという名称のサービス（理由の如何を問わずサービスの名称または内容が変更された場合は、当該変更後のサービスを含みます。）を意味します。</li>
          </ol>
        </div>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第3条（登録）</p>
          <ol class="m-list m-list--ordered">
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第4条（登録事項の変更）</p>
          <p>登録ユーザーは、登録事項に変更があった場合、当社の定める方法により当該変更事項を遅滞なく当社に通知するものとします。</p>
        </div>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第5条（パスワード及びユーザーIDの管理）</p>
          <ol class="m-list m-list--ordered">
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第6条（禁止事項）</p>
          ...
          <ol class="m-list m-list--ordered">
            ...
            <li class="l-group l-group--xs">
              <p>本サービスを通じ、以下に該当し、または該当すると当社が判断する情報を当社または本サービスの他の利用者に送信すること</p>
            ...
            <li>当社ウェブサイト上で掲載する本サービス利用に関するルール（http://.......）に抵触する行為</li>
            <li>反社会的勢力等への利益供与</li>
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第7条（本サービスの停止等）</p>
          <ol class="m-list m-list--ordered">
            <li class="l-group l-group--xs">
              <p>当社は、以下のいずれかに該当する場合には、登録ユーザーに事前に通知することなく、本サービスの全部または一部の提供を停止または中断することができるものとします。</p>
              <ol class="m-list m-list--ordered">
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第8条（権利帰属）</p>
          <ol class="m-list m-list--ordered">
            ...
            <li>登録ユーザーは、登録データについて、自らが投稿その他送信することについての適法な権利を有していること、及び投稿データが第三者の権利を侵害していないことについて、当社に対し表明し、保証するものとします。</li>
            <li>登録ユーザーは、登録データについて、当社に対し、世界的、非独占的、無償、サブライセンス可能かつ譲渡可能な使用、複製、配布、派生著作物の作成、表示及び実行に関するライセンスを付与します。また、他の登録ユーザーに対しても、本サービスを利用して登録ユーザーが投稿その他送信した投稿データの使用、複製、配布、派生著作物を作成、表示及び実行することについての非独占的なライセンスを付与します。</li>
            <li>登録ユーザーは、当社及び当社から権利を承継しまたは許諾された者に対して著作者人格権を行使しないことに同意するものとします。</li>
          </ol>
        </div>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第9条（登録抹消等）</p>
          <ol class="m-list m-list--ordered">
            <li class="l-group l-group--xs">
              <p>当社は、登録ユーザーが、以下の各号のいずれかの事由に該当する場合は、事前に通知または催告することなく、登録データを削除しもしくは当該登録ユーザーについて本サービスの利用を一時的に停止し、または登録ユーザーとしての登録を抹消、もしくはサービス利用契約を解除することができます。</p>
              <ol class="m-list m-list--ordered">
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第10条（退会）</p>
          <ol class="m-list m-list--ordered">
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第11条（本サービスの内容の変更、終了）</p>
          <ol class="m-list m-list--ordered">
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第12条（保証の否認及び免責）</p>
          <ol class="m-list m-list--ordered">
            ...
            <li>何らかの理由により当社が責任を負う場合であっても、当社は、付随的損害、間接損害、特別損害、将来の損害及び逸失利益にかかる損害については、賠償する責任を負わないものとします。</li>
            <li>本サービスまたは当社ウェブサイトに関連して登録ユーザーと他の登録ユーザーまたは第三者との間において生じた取引、連絡、紛争等については、当社は一切責任を負いません。</li>
          </ol>
        </div>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第13条（秘密保持）</p>
          <p>登録ユーザーは、本サービスに関連して当社が登録ユーザーに対して秘密に取り扱うことを求めて開示した非公知の情報について、当社の事前の書面による承諾がある場合を除き、秘密に取り扱うものとします。</p>
        </div>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第14条（利用者情報の取扱い）</p>
          <ol class="m-list m-list--ordered">
            <li>当社による登録ユーザーの利用者情報の取扱いについては、別途当社プライバシーポリシー（http://www…）の定めによるものとし、登録ユーザーはこのプライバシーポリシーに従って当社が登録ユーザーの利用者情報を取扱うことについて同意するものとします。</li>
            <li>当社は、登録ユーザーが当社に提供した情報、データ等を、個人を特定できない形での統計的な情報として、当社の裁量で、利用及び公開することができるものとし、登録ユーザーはこれに異議を唱えないものとします。</li>
          </ol>
        </div>

        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第15条（本規約等の変更）</p>
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第18条（分離可能性）</p>
        ...
        <div class="l-group l-group--xs">
          <p class="m-text m-text--bold">第19条（準拠法及び管轄裁判所）</p>
          <ol class="m-list m-list--ordered">
        ...
        <p class="m-text m-text--rtl">2015年10月20日制定</p>
