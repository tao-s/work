                ...
                <form action="{{ url('/job') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="margin-bottom20">
                        <ul class="nav nav-tabs">
                            ...
                            <li role="presentation"><a href="{{ url('/job/create?franchise=1') }}">フランチャイズ求人</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xs-6 form-adjust">
                        ...
                        <select id="inputBusinessType" class="form-control pull-left" data-title="業態" name="business_type_id">
