    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <form action="{{ url('/job/franchise') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="margin-bottom20">
                        <ul class="nav nav-tabs">
                            <li role="presentation" class=""><a href="{{ url('/job/create') }}">通常求人</a></li>
                    ...
                    <div class="col-xs-12 form-adjust">
                        ...
                        <select id="inputClient" class="form-control pull-left" data-title="クライアント" name="client_id">
                            @foreach($clients as $client)
                                <option {{ ViewHelper::selected($client->id, $data->client_id) }} value="{{ $client->id }}">{{ $client->company_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-xs-12 form-adjust">
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <input name="main_image_filename" type="hidden" value="{{ $data->main_image }}"></div>
                        </div>
                    </div>
